        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12" style="margin-top: 2rem;">
            <div class="request-quote-panel">
              <div class="request__panel-banner bg-overlay bg-overlay-theme bg-img" style="background-image: url(&quot;assets/images/banners/2.jpg&quot;); background-size: cover; background-position: center center;">
                ...
                <div class="request__form-body">
                  <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                      <h4 class="request__form-title">Get a free Demo</h4>
